...
KC_NUBS, KC_Q,  KC_W,          KC_E,              KC_R,    KC_T,  KC_LGUI,
KC_MINS, KC_A,  LT(NUMB,KC_S), KC_LSFT,           KC_F,    KC_G,
KC_GRV,  KC_Y,  KC_X,          KC_C,              KC_V,    KC_B,  KC_INS,
KC_NO,   KC_NO, KC_NO,         KC_NO,             MT(MOD_LCTL|MOD_LALT,KC_EQL),
...
_NOKEY    _NOKEY  MT(MOD_LCTL|MOD_LALT,KC_SCLN),    KC_NO,   KC_NO,         KC_NO,   KC_NO,
KC_NO,                        KC_PSCR,
TG(NUMB),
...
KC_TRNS,   CAPS_SLSH, CAPS_D,  ,  KC_GT,     CAPS_BSLS, KC_TRNS,
